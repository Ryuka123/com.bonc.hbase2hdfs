...
public class Test {
	...
	static {
		...
		config.set("hbase.zookeeper.quorum", "192.168.159.100");
	 ...
	 * @return 结果集
	 */
	public static TBData getDataMap(String tableName, String startRow, String stopRow, Integer currentPage, Integer pageSize) throws IOException {
...
//		filterList.addFilter(filter2);
	...
	private static List<Get> getList(List<byte[]> rowList) {
		...
		for (byte[] row : rowList) {
			Get get = new Get(row);
//			get.addColumn(getBytes("info"), getBytes("column1"));
			list.add(get);
		}
		return list;
	}
	...
	public static void main(String[] args) throws IOException {
		// 拿出row key的起始行和结束行
		// #<0<9<:								 
		String startRow = " 04455070001002580201700000000000";
		String stopRow =   "04455070001145200201799999999999";
		int currentPage = 1;
		int pageSize = 10;
		// 执行hbase查询
		getDataMap("testTable", startRow, stopRow, currentPage, pageSize);
